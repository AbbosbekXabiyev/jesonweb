...
function GridTwo(props) {
  return (
    <div className="bg-myGray rounded-[20px] px-4">
      ...
      <div className="">
        <h1 className="font-light text-[27px] text-white text-center">
          {props.sarlavha}
        </h1>
        <p className="text-[18px] fond-normal text-white">{props.text}</p>
